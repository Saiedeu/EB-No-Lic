        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            <div class="mb-4 md:mb-0">
                <div class="site-name-badge text-xl font-bold mb-2">
                    <?php echo TXT_LOGO; ?>
                    <div class="site-tagline"><?php echo getSetting('site_tagline', 'Exchange Taka Globally'); ?></div>
                </div>
...
<div id="floating-buttons-container">
    ...
    <!-- System Tawk.to Button -->
    <?php if (getSetting('enable_tawkto', 'yes') === 'yes' && !empty(getSetting('tawkto_widget_code', ''))): ?>
    <div id="system-tawkto-btn" 
         class="floating-btn system-btn tawkto-system" 
         onclick="openSystemTawktoChat()" 
         title="Live Chat Support"
         data-system-button="tawkto">
...
/* System Buttons Fixed Positions */
.whatsapp-system {
    bottom: 20px;
    left: 20px;
