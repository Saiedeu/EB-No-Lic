<?php
// Start session and initialize security
session_start();
...
<div id="exchange-wizard" class="mb-8">
    ...
    <div id="step-1-exchange" class="exchange-step bg-white dark:bg-gray-800 rounded-lg shadow-card overflow-hidden mb-6 section-bg animated-border">
        ...
        <div class="p-4 section-content">
            ...
            <div class="exchange-form-container mx-auto">
                <form id="exchange-form" class="exchange-form-desktop">
                    <!-- CSRF Protection -->
                    <input type="hidden" name="csrf_token" value="<?php echo $security->generateCSRFToken(); ?>">
                    
                    <!-- SEND Section -->
                    <div class="exchange-form-section send-section">
                    ...
                    <!-- RECEIVE Section -->
                    <div class="exchange-form-section receive-section">
                        <div class="text-center mb-3">
...
/* Exchange Form Styling - UPDATED FOR DESKTOP SIDE BY SIDE */
.exchange-form-container {
    position: relative;
    max-width: 500px;
}

.exchange-form-desktop {
    position: relative;
    display: flex;
...
@media (min-width: 768px) {
    ...
    .exchange-form-desktop {
        ...
        grid-template-areas: 
            "send-section swap-button receive-section";
        gap: 1.5rem;
        align-items: start;
    }
    
    .send-section {
        grid-area: send-section;
    }
...
/* Desktop specific positioning for swap button */
@media (min-width: 768px) {
    .exchange-direction-container {
        height: auto;
        align-items: center;
