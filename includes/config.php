...
if (!defined('DB_NAME')) define('DB_NAME', 'if0_38847374_LLL'); // Replace with your actual database name

// Application constants
if (!defined('SITE_URL')) define('SITE_URL', 'https://saieed-rahman.rf.gd/V2'); // Replace with your actual domain
