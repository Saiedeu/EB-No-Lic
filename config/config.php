...
if (!defined('DB_NAME')) define('DB_NAME', 'if0_38847374_Final'); // Replace with your actual database name

// Application constants
if (!defined('SITE_URL')) define('SITE_URL', 'http://demo.exchange-bridge.rf.gd'); // Replace with your actual domain
